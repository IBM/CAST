...
For CSM, all CSM rpms have a version of ibm-csm-component-1.5.0-commit_sequence.ppc64le.rpm, for example, ibm-csm-core-1.5.0-2137.ppc64le.rpm.  The commit_sequence portion is an increasing value that changes every time a new commit is added to the repository. Because the commit_sequence changes so frequently, this document makes use of a wildcard for this portion of the rpm name.
...
.. code-block:: bash
  ...
  $ rpm -ivh ibm-flightlog-1.5.0-*.ppc64le.rpm \
  ibm-csm-core-1.5.0-*.ppc64le.rpm \
  ibm-csm-api-1.5.0-*.ppc64le.rpm  \
  ibm-csm-db-1.5.0-*.noarch.rpm \
  ibm-csm-bds-1.5.0-*.noarch.rpm \
  ibm-csm-hcdiag-1.5.0-*.noarch.rpm \
  ibm-csm-restd-1.5.0-*.ppc64le.rpm
...
.. code-block:: bash
  ...
  ibm-csm-core-1.5.0-*.ppc64le
  ibm-csm-api-1.5.0-*.ppc64le
  ibm-csm-bds-1.5.0-*.noarch
  ibm-csm-bds-logstash-1.5.0-*.noarch
  ibm-csm-hcdiag-1.5.0-*.noarch
  ibm-csm-restd-1.5.0-*.ppc64le
...
.. code-block:: bash
  ...
  ibm-csm-api-1.5.0-*.ppc64le.rpm \
  ibm-csm-bds-1.5.0-*.noarch.rpm \
  ibm-csm-bds-logstash-1.5.0-*.noarch.rpm \
  ibm-csm-hcdiag-1.5.0-*.noarch.rpm \
  ibm-csm-restd-1.5.0-*.ppc64le.rpm
