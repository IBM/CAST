...
#================================================================================
#   
#    hcdiag/src/tests/hxefpu64/hxefpu64.sh
# 
...
rule="fpu:fpu.coral.pass$pass"
thismdt="${htxd_root}/mdt/mdt.hxefpu4.coral_pass${pass}"
...
if [ $rc -eq 0 ]; then 
   # creates the mdt file to run hxefpu64
   if [ $pass -eq 2 ]; then thisrule="fpu:"; fi
