 ...
 * @ref CSMERR_MSG_UNPACK_ERROR | Unable to unpack a message payload.
 */
int csm_switch_attributes_query(csm_api_object **handle, csm_switch_attributes_query_input_t* input, 
 ...
 *      @ref CSMERR_MSG_UNPACK_ERROR | Unable to unpack a message payload.
 */
int csm_switch_attributes_query_details(csm_api_object **handle, csm_switch_attributes_query_details_input_t* input, 
