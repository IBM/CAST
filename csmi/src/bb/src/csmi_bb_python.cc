...
BOOST_PYTHON_MODULE(lib_csm_bb_py)
{
    ...
    class_<csm_bb_lv_delete_input_t,csm_bb_lv_delete_input_t*>("bb_lv_delete_input_t")
		...
		.add_property("num_bytes_read", &csm_bb_lv_delete_input_t::num_bytes_read,&csm_bb_lv_delete_input_t::num_bytes_read," Number of bytes read during the life of this partition.")
		.add_property("num_bytes_written", &csm_bb_lv_delete_input_t::num_bytes_written,&csm_bb_lv_delete_input_t::num_bytes_written," Number of bytes written during the life of this partition.")
