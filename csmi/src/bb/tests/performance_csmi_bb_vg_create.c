/*================================================================================
    ...
    csmi/src/bb/tests/performance_csmi_bb_vg_create.c
...
int csmi_client(int argc, char *argv[])
{
	...
	//fill with test data
	input->ssd_info[0]->ssd_serial_number = strdup("abc123");
	...
	input->total_size = 500;
	input->vg_name = strdup("VG_performance_test");
