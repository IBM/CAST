...
BOOST_PYTHON_MODULE(lib_csm_py)
{
    ...
    enum_<csmi_cmd_err_t>("csmi_cmd_err_t")
		...
		.value("CSMERR_EPILOG_PROLOG_COLLISION",CSMERR_EPILOG_PROLOG_COLLISION)
		.value("CSMERR_PROLOG_EPILOG_COLLISION",CSMERR_PROLOG_EPILOG_COLLISION)
		.value("CSMERR_PROLOG_PROLOG_COLLISION",CSMERR_PROLOG_PROLOG_COLLISION)
		.value("CSMERR_SOFT_FAIL_RECOVERY_AGENT",CSMERR_SOFT_FAIL_RECOVERY_AGENT);
    ...
    enum_<csmi_node_state_t>("csmi_node_state_t")
		...
		.value("CSM_NODE_HARD_FAILURE",CSM_NODE_HARD_FAILURE);
