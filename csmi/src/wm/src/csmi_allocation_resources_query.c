/*================================================================================
    ...
    csmi/src/wm/src/csmi_allocation_resources_query.c
...
int csm_allocation_resources_query(
    ...
    API_PARAMETER_OUTPUT_TYPE **output )
{
    ...
    create_csm_api_object(handle, expected_cmd, 
        csmi_allocation_resources_query_destroy);
