/*================================================================================
    ...
    csmi/src/wm/src/csmi_allocation_query.c
...
{ 
    ...
    create_csm_api_object(handle, expected_cmd, csmi_allocation_query_destroy);
...
void csmi_allocation_query_destroy(csm_api_object *handle)
{
    ...
    API_PARAMETER_OUTPUT_TYPE *allocation;
    ...
    allocation = (API_PARAMETER_OUTPUT_TYPE *) csmi_hdl->ret_cdata;
    csm_free_struct_ptr( API_PARAMETER_OUTPUT_TYPE, allocation);
