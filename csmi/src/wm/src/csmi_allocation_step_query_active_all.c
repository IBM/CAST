/*================================================================================
    ...
    csmi/src/wm/src/csmi_allocation_step_query_active_all.c
...
int csm_allocation_step_query_active_all(
    ...
    API_PARAMETER_OUTPUT_TYPE **output) 
{
    ...
    create_csm_api_object(handle, expected_cmd, csmi_allocation_step_query_active_all_destroy);
