/*================================================================================
    ...
    csmi/src/wm/src/csmi_allocation_query_active_all.c
...
int csm_allocation_query_active_all(
    ...
    API_PARAMETER_OUTPUT_TYPE **output)
{
    ...
    create_csm_api_object(handle, expected_cmd, csmi_allocation_query_active_all_destroy);
    
    // Send a Message to the Backend.
    error_code = csmi_sendrecv_cmd( *handle, expected_cmd, 
        NULL, 0, &return_buffer, &return_buffer_len );
...
void csmi_allocation_query_active_all_destroy(csm_api_object *handle)
{
    ...
    csmutil_logging(info,"csmi_allocation_query_active_all_destroy called");
}
