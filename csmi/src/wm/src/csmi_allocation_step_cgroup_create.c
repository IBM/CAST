/*================================================================================
    ...
    csmi/src/wm/src/csmi_allocation_step_cgroup_create.c
...
int csm_allocation_step_cgroup_create(
    ...
    API_PARAMETER_INPUT_TYPE* cgroup_args)
{
    START_TIMING()
    ...
    csm_serialize_struct( API_PARAMETER_INPUT_TYPE, cgroup_args, &buffer, &buffer_length);
