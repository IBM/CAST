/*================================================================================
    ...
    csmi/src/wm/cmd/allocation_step_query_details.c
...
#define USAGE csm_free_struct(csm_allocation_step_query_details_input_t, input); help

void help() {
	puts("_____CSM_ALLOCATION_STEP_QUERY_DETAILS_CMD_HELP_____");
	puts("USAGE:");
	...
	puts("");
	puts("SUMMARY: Used to gather advanced information about a step from the CSM database.");
	puts("");
	puts("EXIT STATUS:");
	puts("  0  if OK,");
	puts("  1  if ERROR.");
	...
	puts("ARGUMENTS:");
	puts("  MANDATORY:");
	puts("    csm_allocation_step_query_details expects 1 mandatory argument");
	puts("    Argument                | Example value      | Description  ");                                                 
	puts("    ------------------------|--------------------|--------------");
	puts("    -a, --allocation_id     | 1                  | (STRING) Primary job id (for lsf this will be the lsf job id).");
	puts("                            |                    | ");
	puts("  OPTIONAL:");
	puts("    csm_allocation_step_query_details can have 1 optional argument");
	puts("    Argument                | Example value      | Description  ");                                                 
	puts("    ------------------------|--------------------|--------------");
	puts("    -s, --step_id           | 1                  | (STRING) Primary job id (for lsf this will be the lsf job id).");
	puts("                            |                    | ");
	puts("");
	...
	puts("  csm_allocation_step_query_details -a 1");
	puts("");
...
/*
* Summary: Simple command line interface for the CSM API 'allocation step query details'. 
...
int main(int argc, char *argv[])
{
	...
	return_value = csm_allocation_step_query_details(&csm_obj, &input, &output);
