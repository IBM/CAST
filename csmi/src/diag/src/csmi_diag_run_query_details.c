/*================================================================================
    ...
    csmi/src/diag/src/csmi_diag_run_query_details.c
...
int csm_diag_run_query_details(
...
void csmi_diag_run_query_details_destroy(csm_api_object *csm_obj)
{
    ...
    output = (csm_diag_run_query_details_output_t*) csmi_hdl->ret_cdata;
    csm_free_struct_ptr( csm_diag_run_query_details_output_t, output );
}
