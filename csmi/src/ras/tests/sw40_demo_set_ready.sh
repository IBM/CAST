...
#================================================================================
#
#    csmi/src/ras/tests/sw40_demo_set_ready.sh 
#
...
msg_id="custom.trigger.set_ready"
echo $msg_id
...
# Confirm the node is set to ready='n' 
...
--message 'Setting $(location_name) to ready=y' \
--severity INFO --threshold_count 1 --threshold_period 1 \
--set_ready 't'
...
# Confirm that the compute node has been set to ready='y'
csm_node_attributes_query -n "$compute_node" | egrep "node_name|ready|state"
