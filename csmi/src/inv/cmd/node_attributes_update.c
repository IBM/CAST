...
void help(){
	...
	puts("    -1, --feature_1               | \"My cool feature1\"   | (STRING) Reserved fields for future use.");
	puts("    -2, --feature_2               | \"My cool feature2\"   | (STRING) Reserved fields for future use.");
	puts("    -3, --feature_3               | \"My cool feature3\"   | (STRING) Reserved fields for future use.");
	puts("    -4, --feature_4               | \"My cool feature4\"   | (STRING) Reserved fields for future use.");
	puts("");
