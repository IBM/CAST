/*================================================================================
    ...
    csmi/src/inv/src/csmi_cluster_query_state.c
...
const static csmi_cmd_t expected_cmd = CSM_CMD_cluster_query_state;

void csmi_cluster_query_state_destroy(csm_api_object *csm_obj);

int csm_cluster_query_state(
    ...
    API_PARAMETER_OUTPUT_TYPE** output)
{
    ...
    create_csm_api_object(csm_obj, expected_cmd, csmi_cluster_query_state_destroy);
