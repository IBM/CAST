/*================================================================================
    ...
    csmi/src/inv/src/csmi_node_query_state_history.c
...
int csm_node_query_state_history(
    ...
    API_PARAMETER_OUTPUT_TYPE** output)
{
    ...
    create_csm_api_object(csm_obj, expected_cmd, csmi_node_query_state_history_destroy);
