/*================================================================================
    ...
    csmi/src/inv/src/csmi_switch_attributes_query_history.c
...
int csm_switch_attributes_query_history(
    ...
    API_PARAMETER_OUTPUT_TYPE* *output)
{
    ...
    create_csm_api_object(csm_obj, expected_cmd, csmi_switch_attributes_query_history_destroy);
...
void csmi_switch_attributes_query_history_destroy(csm_api_object *csm_obj)
{
    ...
    output = (csm_switch_attributes_query_history_output_t *) csmi_hdl->ret_cdata;
