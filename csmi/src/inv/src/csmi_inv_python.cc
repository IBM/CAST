...
BOOST_PYTHON_MODULE(lib_csm_inv_py)
{
    ...
    class_<csm_ib_cable_query_input_t,csm_ib_cable_query_input_t*>("ib_cable_query_input_t")
		...
		.add_property("comments_count", &csm_ib_cable_query_input_t::comments_count,&csm_ib_cable_query_input_t::comments_count," Number of comment strings to query on, size of @ref comment. ")
		ARRAY_STR_PROPERTY(csm_ib_cable_query_input_t, char**, comments, comments_count, NULL, )
		...
		ARRAY_STR_PROPERTY(csm_ib_cable_query_input_t, char**, guids, guids_count, NULL, )
		.add_property("identifiers_count", &csm_ib_cable_query_input_t::identifiers_count,&csm_ib_cable_query_input_t::identifiers_count," Number of identifier strings to query on, size of @ref identifier. ")
		ARRAY_STR_PROPERTY(csm_ib_cable_query_input_t, char**, identifiers, identifiers_count, NULL, )
		...
		ARRAY_STR_PROPERTY(csm_ib_cable_query_input_t, char**, lengths, lengths_count, NULL, )
		.add_property("names_count", &csm_ib_cable_query_input_t::names_count,&csm_ib_cable_query_input_t::names_count," Number of name strings to query on, size of @ref name. ")
		ARRAY_STR_PROPERTY(csm_ib_cable_query_input_t, char**, names, names_count, NULL, )
		.add_property("part_numbers_count", &csm_ib_cable_query_input_t::part_numbers_count,&csm_ib_cable_query_input_t::part_numbers_count," Number of part_number strings to query on, size of @ref part_number. ")
		ARRAY_STR_PROPERTY(csm_ib_cable_query_input_t, char**, part_numbers, part_numbers_count, NULL, )
		...
		.add_property("revisions_count", &csm_ib_cable_query_input_t::revisions_count,&csm_ib_cable_query_input_t::revisions_count," Number of revision strings to query on, size of @ref revision. ")
		ARRAY_STR_PROPERTY(csm_ib_cable_query_input_t, char**, revisions, revisions_count, NULL, )
		.add_property("severities_count", &csm_ib_cable_query_input_t::severities_count,&csm_ib_cable_query_input_t::severities_count," Number of severity strings to query on, size of @ref severity. ")
		ARRAY_STR_PROPERTY(csm_ib_cable_query_input_t, char**, severities, severities_count, NULL, )
