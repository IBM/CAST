...
BOOST_PYTHON_MODULE(lib_csm_inv_py)
{
    ...
    class_<csm_ib_cable_query_input_t,csm_ib_cable_query_input_t*>("ib_cable_query_input_t")
		...
		.add_property("comment_count", &csm_ib_cable_query_input_t::comment_count,&csm_ib_cable_query_input_t::comment_count," Number of comment strings to query on, size of @ref comment. ")
		ARRAY_STR_PROPERTY(csm_ib_cable_query_input_t, char**, comment, type_count, NULL, )
		.add_property("guids_count", &csm_ib_cable_query_input_t::guids_count,&csm_ib_cable_query_input_t::guids_count," Number of guid strings to query on, size of @ref guids. ")
		ARRAY_STR_PROPERTY(csm_ib_cable_query_input_t, char**, guids, guid_s1_count, NULL, )
		.add_property("identifier_count", &csm_ib_cable_query_input_t::identifier_count,&csm_ib_cable_query_input_t::identifier_count," Number of identifier strings to query on, size of @ref identifier. ")
		ARRAY_STR_PROPERTY(csm_ib_cable_query_input_t, char**, identifier, indentifier_count, NULL, )
		.add_property("lengths_count", &csm_ib_cable_query_input_t::lengths_count,&csm_ib_cable_query_input_t::lengths_count," Number of length strings to query on, size of @ref length. ")
		ARRAY_STR_PROPERTY(csm_ib_cable_query_input_t, char**, length, length_count, NULL, )
		.add_property("name_count", &csm_ib_cable_query_input_t::name_count,&csm_ib_cable_query_input_t::name_count," Number of name strings to query on, size of @ref name. ")
		ARRAY_STR_PROPERTY(csm_ib_cable_query_input_t, char**, name, name_count, NULL, )
		.add_property("part_number_count", &csm_ib_cable_query_input_t::part_number_count,&csm_ib_cable_query_input_t::part_number_count," Number of part_number strings to query on, size of @ref part_number. ")
		ARRAY_STR_PROPERTY(csm_ib_cable_query_input_t, char**, part_number, part_number_count, NULL, )
		.add_property("ports_count", &csm_ib_cable_query_input_t::ports_count,&csm_ib_cable_query_input_t::ports_count," Number of port strings to query on, size of @ref ports. ")
		ARRAY_STR_PROPERTY(csm_ib_cable_query_input_t, char**, ports, ports_count, NULL, )
		.add_property("revision_count", &csm_ib_cable_query_input_t::revision_count,&csm_ib_cable_query_input_t::revision_count," Number of revision strings to query on, size of @ref revision. ")
		ARRAY_STR_PROPERTY(csm_ib_cable_query_input_t, char**, revision, revision_count, NULL, )
		.add_property("severity_count", &csm_ib_cable_query_input_t::severity_count,&csm_ib_cable_query_input_t::severity_count," Number of severity strings to query on, size of @ref severity. ")
		ARRAY_STR_PROPERTY(csm_ib_cable_query_input_t, char**, severity, severity_count, NULL, )
		.add_property("type_count", &csm_ib_cable_query_input_t::type_count,&csm_ib_cable_query_input_t::type_count," Number of type strings to query on, size of @ref type. ")
		ARRAY_STR_PROPERTY(csm_ib_cable_query_input_t, char**, type, type_count, NULL, )
		.add_property("width_count", &csm_ib_cable_query_input_t::width_count,&csm_ib_cable_query_input_t::width_count," Number of width strings to query on, size of @ref width. ")
		ARRAY_STR_PROPERTY(csm_ib_cable_query_input_t, char**, width, type_count, NULL, );
