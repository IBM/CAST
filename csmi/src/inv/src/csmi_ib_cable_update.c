/*================================================================================
    ...
    csmi/src/inv/src/csmi_ib_cable_update.c
    ...
    API_PARAMETER_OUTPUT_TYPE* *output)
{
    ...
    create_csm_api_object(csm_obj, expected_cmd, csmi_ib_cable_update_destroy);
    ...
    if ( error_code == CSMI_SUCCESS )
    {
                ...
                return_buffer, return_buffer_length ) == 0 )
        {
            ...
            {
                csmutil_logging(error, "Could not update %d ib cable(s)", 
