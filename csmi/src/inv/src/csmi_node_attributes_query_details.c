/*================================================================================
    ...
    csmi/src/inv/src/csmi_node_attributes_query_details.c
...
int csm_node_attributes_query_details(
    ...
    API_PARAMETER_OUTPUT_TYPE** output )
{
    ...
    create_csm_api_object(csm_obj, expected_cmd, csmi_node_attributes_query_details_destroy);
