/*================================================================================
    ...
    csmi/src/inv/src/csmi_switch_attributes_query.c
...
int csm_switch_attributes_query(
    ...
    API_PARAMETER_OUTPUT_TYPE* *output)
{
    ...
    create_csm_api_object(csm_obj, expected_cmd, csmi_switch_attributes_query_destroy);
...
void csmi_switch_attributes_query_destroy(csm_api_object *csm_obj)
{
    ...
    output = (csm_switch_attributes_query_output_t *) csmi_hdl->ret_cdata;
    csm_free_struct_ptr( csm_switch_attributes_query_output_t, output );
}
