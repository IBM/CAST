...
check_return_flag_value $? 0 "Test Case 1: Small message protocol - return code"
...
check_return_flag_value $? 0 "Test Case 2: Partial message protocol - return code"
...
check_return_flag_value $? 3 "Test Case 3: Large message protocol - return code"
...
check_return_flag_value $? 0 "Test Case 3: Large message protocol - return code" 
