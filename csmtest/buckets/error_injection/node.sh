...
check_return_flag $? "Test Case 13: csm_node_delete on multiple nodes (1 exists, one does not)"
...
check_return_flag_nz $? 8 "Test Case 14: csm_node_attributes_update NO ARGS"
...
check_return_flag_nz $? 8 "Test Case 15: csm_node_attributes_update only 1 of 2 required inputs"
...
check_return_flag_nz $? 27 "Test Case 16: csm_node_attributes_update node does not exist, valid input otherwise"

# Test Case 17: csm_node_attributes_update no usable -n input
${CSM_PATH}/csm_node_attributes_update -n , -r y > ${TEMP_LOG} 2>&1
check_return_flag_nz $? 9 "Test Case 17: csm_node_attributes_update no usable -n input"
...
check_return_flag_nz $? 9 "Test Case 18: csm_node_attributes_update invalid option"
...
check_return_flag_nz $? 9 "Test Case 19: csm_node_attributes_update invalid secondary input (-r)"
...
check_return_flag_nz $? 9 "Test Case 20: csm_node_attributes_update invalid -s input"

# Test Case 21: csm_node_attributes_query_history NO ARGS
${CSM_PATH}/csm_node_attributes_query_history > ${TEMP_LOG} 2>&1
check_return_flag_nz $? 8 "Test Case 21: csm_node_attributes_query_history NO ARGS"
...
check_return_flag_nz $? 4 "Test Case 22: csm_node_attributes_query_history multiple nodes / node does not exist"

# Test Case 23: csm_node_attributes_query_history invalid option
${CSM_PATH}/csm_node_attributes_query_history -x 1 > ${TEMP_LOG} 2>&1
check_return_flag_nz $? 9 "Test Case 23: csm_node_attributes_query_history invalid option"

# Test Case 24: csm_node_attributes_query_details NO ARGS
${CSM_PATH}/csm_node_attributes_query_details > ${TEMP_LOG} 2>&1
check_return_flag_nz $? 8 "Test Case 24: csm_node_attributes_query_details NO ARGS"
...
check_return_flag_nz $? 4 "Test Case 25: csm_node_attributes_query_details multiple nodes / node does not exist"

# Test Case 26: csm_node_attributes_query_details invalid option
${CSM_PATH}/csm_node_attributes_query_details -x 1 > ${TEMP_LOG} 2>&1
check_return_flag_nz $? 9 "Test Case 26: csm_node_attributes_query_details invalid option"
