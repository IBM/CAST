...
check_return_flag_value $? 25 "Test Case 17: csm_bb_vg_delete vg name does not exist"

# Test Case 18: csm_bb_vg_delete no vg input
${CSM_PATH}/csm_bb_vg_delete -V > ${TEMP_LOG} 2>&1
check_return_flag_value $? 9 "Test Case 18: csm_bb_vg_delete no vg input"

# Test Case 19: csm_bb_vg_delete invalid option
${CSM_PATH}/csm_bb_vg_delete -x invalidoption > ${TEMP_LOG} 2>&1
check_return_flag_value $? 9 "Test Case 19: csm_bb_vg_delete invalid option"

# LV DELETE Section
# Test Case 20: csm_bb_lv_delete NO ARGS
${CSM_PATH}/csm_bb_lv_delete > ${TEMP_LOG} 2>&1
check_return_flag_value $? 8 "Test Case 20: csm_bb_lv_delete NO ARGS"
...
check_return_flag_value $? 25 "Test Case 21: csm_bb_lv_delete allocation does not exist"
...
check_return_flag_value $? 9 "Test Case 22: csm_bb_lv_delete invalid allocation input type"
...
check_return_flag_value $? 9 "Test Case 23: csm_bb_lv_delete no allocation input"
...
check_return_flag_value $? 25 "Test Case 24: csm_bb_lv_delete lv does not exist"
...
check_return_flag_value $? 25 "Test Case 25: csm_bb_lv_delete node name does not exist"
...
check_return_flag_value $? 9 "Test Case 26: csm_bb_lv_delete invalid read input type"
...
check_return_flag_value $? 9 "Test Case 27: csm_bb_lv_delete invalid write input type"

# Test Case 28: csm_bb_lv_delete invalid option
${CSM_PATH}/csm_bb_lv_delete -x invalidoption > ${TEMP_LOG} 2>&1
check_return_flag_value $? 9 "Test Case 28: csm_bb_lv_delete invalid option"
