...
TARGETFILE=$GPFSDIR/stagout_$LSB_JOBID
SOURCEFILE==$BBPATH/stagout_$LSB_JOBID
...
echo "Jobid $LSF_STAGE_JOBID:" $( date ) inside user stageout script $( basename $BASH_SOURCE )
