...
# Build the request
request  = urllib2.Request(URL,json_payload, {'Content-Type': 'application/json', 'Content-Length': json_len})
request.add_header('Authorization', 'Basic %s' % ("%s:%s" % (username,password)).encode('base64').strip())
