...
# ================================================================================
'''
.. module::ut_find_job_metrics
:platform: Linux
:synopsis: Tests the find_job_metrics use case.
.. moduleauthor:: John Dunham (jdunham@us.ibm.com)
'''

import unittest
import context
import usecases.find_job_metrics as find_job_metrics
...
class JobMetricsTest(unittest.TestCase):
    ...
    def test_valid_job(self):
        ...
        with self.assertRaises(SystemExit) as rv:
            find_job_metrics.main(self.tests["test_valid_job"])
    ...
    def test_invalid_job(self):
        ...
        with self.assertRaises(SystemExit) as rv:
            find_job_metrics.main(self.tests["test_invalid_job"])
    ...
    def test_illegal_job(self):
        ...
        with self.assertRaises(SystemExit) as rv:
            find_job_metrics.main(self.tests["test_illegal_jobid"])
