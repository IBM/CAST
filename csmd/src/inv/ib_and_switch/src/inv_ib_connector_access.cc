...
int INV_IB_CONNECTOR_ACCESS::ExecuteDataCollection(std::string rest_address, std::string authentication_string_for_the_http_request)
{
	try
	{
		...
		if ( ! input_file.is_open() ){
			...
			bad_ib_cable_records.open ("/var/log/ibm/csm/inv/bad_ib_cable_records.txt");
					...
					if ( line.find(comparing_string) != std::string::npos ){
						...
						switch (i)
						{
							...
							case 2:
								...
								break;
							case 3:
								if(bad_record == false){ vector_of_the_identifiers.push_back(line); }
								else{bad_ib_cable_records << "identifier:       " << line << std::endl;}
								break;
							case 4:
								if(bad_record == false){ vector_of_the_technologies.push_back(line); }
								else{bad_ib_cable_records << "technology:       " << line << std::endl;}
								break;
							case 5:
								if(bad_record == false){ vector_of_the_revisions.push_back(line); }
								else{bad_ib_cable_records << "revision:         " << line << std::endl; }
								break;
							case 6:
								if(bad_record == false || missing_cable_info == false){ vector_of_the_severities.push_back(line); }
								else{bad_ib_cable_records << "severity:         " << line << std::endl; }
								break;
							case 7:
								if(bad_record == false || missing_cable_info == false){ vector_of_the_source_guids.push_back(line); }
								else{bad_ib_cable_records << "source_guid:      " << line << std::endl; }
								break;
							case 8:
								if(bad_record == false || missing_cable_info == false){ vector_of_the_widths.push_back(line); }
								else{bad_ib_cable_records << "width:            " << line << std::endl; }
								break;
							case 9:
								if(bad_record == false || missing_cable_info == false){ vector_of_the_source_ports.push_back(line); }
								else{bad_ib_cable_records << "source_port:      " << line << std::endl; }
								break;
							case 10:
								if(bad_record == false || missing_cable_info == false){ vector_of_the_destination_ports.push_back(line); }
								else{bad_ib_cable_records << "destination_port: " << line << std::endl; }
								break;
							case 11:
								if(bad_record == false || missing_cable_info == false){ vector_of_the_destination_guids.push_back(line); }
								else{bad_ib_cable_records << "destination_guid: " << line << std::endl; }
								break;
							case 12:
								if(bad_record == false || missing_cable_info == false){ vector_of_the_names.push_back(line); }
								else{ 
