/*================================================================================
    ...
    csmd/src/daemon/src/csmi_request_handler/CSMINodeResourcesQueryAll.cc
...
#include "CSMINodeResourcesQueryAll.h"

//Used for debug prints
#define STATE_NAME "CSMINodeResourcesQueryAll:"
...
bool CSMINodeResourcesQueryAll::CreatePayload(
        ...
        csm::daemon::EventContextHandlerState_sptr ctx )
{
    ...
    *stringBuffer = NULL;
    ...
    if(numberOfRecords > 0){
		...
		output->results = (csmi_node_resources_record_t**)calloc(
            output->results_count, sizeof(csmi_node_resources_record_t*));
...
void CSMINodeResourcesQueryAll::CreateOutputStruct(
