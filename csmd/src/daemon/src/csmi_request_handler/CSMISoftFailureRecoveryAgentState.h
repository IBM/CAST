/*================================================================================
    ...
    csmd/src/daemon/src/csmi_request_handler/CSMISoftFailureRecoveryAgentState.h
...
================================================================================*/
#ifndef CSMI_SOFT_FAILURE_RECOVERY_AGENT_STATE_H
#define CSMI_SOFT_FAILURE_RECOVERY_AGENT_STATE_H
 ...
 * @param fail_state   
 */
class SoftFailureRecoveryAgentState: public NetworkMessageState
{
