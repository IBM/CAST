/*================================================================================
    ...
    csmd/src/daemon/src/csmi_request_handler/CSMIBBCMDAgentState.h
...
================================================================================*/
#ifndef CSMI_BB_CMD_AGENT_STATE_H
#define CSMI_BB_CMD_AGENT_STATE_H
 ...
 * @param fail_state   
 */
class BBCMDAgentState: public NetworkMessageState
{
