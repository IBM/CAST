/*================================================================================
    ...
    csmd/src/daemon/src/csmi_request_handler/CSMIRasMsgTypeDelete.h
...
*/
#ifndef __CSMI_RAS_MSG_TYPE_DELETE_H__
#define __CSMI_RAS_MSG_TYPE_DELETE_H__

#include "csmi_stateful_db.h"

class CSMIRasMsgTypeDelete : public CSMIStatefulDB {

public:
	CSMIRasMsgTypeDelete(csm::daemon::HandlerOptions &options):CSMIStatefulDB(CSM_CMD_ras_msg_type_delete, options)
	{
