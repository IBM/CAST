/*================================================================================
    ...
    csmd/src/daemon/src/csmi_request_handler/CSMIRasMsgTypeCreate.h
...
*/
#ifndef __CSMI_RAS_MSG_TYPE_CREATE_H__
#define __CSMI_RAS_MSG_TYPE_CREATE_H__

#include "csmi_stateful_db.h"

class CSMIRasMsgTypeCreate : public CSMIStatefulDB {

public:
	CSMIRasMsgTypeCreate(csm::daemon::HandlerOptions &options):CSMIStatefulDB(CSM_CMD_ras_msg_type_create, options)
	{
