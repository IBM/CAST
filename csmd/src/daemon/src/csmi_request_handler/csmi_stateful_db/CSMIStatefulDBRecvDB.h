/*================================================================================
    ...
    csmd/src/daemon/src/csmi_request_handler/csmi_stateful_db/CSMIStatefulDBRecvDB.h
...
================================================================================*/
#ifndef CSMIStatefulDBRecv_h
#define CSMIStatefulDBRecv_h

#include "../csmi_stateful_db.h"
#include "../csmi_db_resp_state.h"

#define STATE_NAME "StatefulDBRecv"
/** @brief 
 *
 * @param state_name   
 * @param target_state 
 * @param fail_state   
 */
class  StatefulDBRecv : public DBRespState
{
